...
**Answer**: THis means that 17.25% of crimes resulted in arrest.
...
**Answer**: 27.52% of crimes were considered thefts.
...
**Answer**: This means that there were 38,816 thefts in this dataset.
...
**Answer**: This number is higher than the mean of the original dataset. We can compare these measurements. THis is saying that 25.70% of crimes in Humboldt Park result in arrest compared to the 17% in the whole dataset.
...
**Answer**: This means that 18.78% of crimes in Humboldt Park are considered thefts.
...
**Answer**: This number is larger and can be compared between datasets becase they both show the number of thefts per 1000 households.
...
```{r}
temp1 <- filter(ca, area_number == 23)
sum(temp1$num_households)
```

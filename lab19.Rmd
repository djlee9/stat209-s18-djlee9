...
**Answer**: No, because its not in the confidence interval.
...
**Answer**: Because if you are going to a lot of burrito restuarants, you are probably trying to go to the best ones, not random ones.
...
**Answer**: Restaurants that include chips with the meal, on average, have a higher yelp score of 0.5699.

Is the slope coefficient statistically significant (compared to zero)?

**Answer**: No, the lower bound of the confidence interval is negative.

Describe this in terms of your answers above.

**Answer**: Although usually chips have higher yelp scores, we cannot say with statistical significance that all restaurants that include chips have higher yelp scores.
...
**Answer**: Yes, however the lower bound on the confidence interval states that we are not completely confident that all high synergy restuarants will have higher yelp scores.

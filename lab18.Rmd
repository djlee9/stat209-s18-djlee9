...
**Answer**: No, this is a measurement of the average (or mean) not the range of the majority.
...
**Answer**: Based on the model, we are 80% sure that the average age of a victim of a murder in London is between the age 33.07 and 34.65.

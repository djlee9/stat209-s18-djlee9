...
ggplot(djia, aes(date, close)) +
  ...
  xlab("Date") +
  ggtitle("DOW Jones (DJIA)") +
  annotate("text", x = as.Date("2016-11-08"), y = 16500, label = "Trump
Elected
President")
...
ggplot(djia, aes(date, close)) +
  ...
  xlab("Date") +
  ggtitle("DOW Jones (DJIA)") +
  annotate("rect", xmin = as.Date("2018-01-25"), xmax = as.Date("2018-02-20"), ymin = 23000, ymax = 27000, fill = "red", alpha = 0.2) +
  annotate("text", x = as.Date("2018-07-01"), y = 25000, label = "Market
...
Elected
President") +
  annotate("text", x = as.Date("2017-11-30"), y = 22000, label = "Tax
Plan
Revealed")
```

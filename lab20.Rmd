...
**Answer**: That a diamond with an extra carat of gold would cost $7,756 more per added carat.
...
**Answer**: Yes, it is outside of the confidence interval.

Would you be surprised if we collected another set of diamonds, in exactly the
same way as before, and found a slope estimate equal to 7500?

**Answer**: Yes, it is still outside of the confidence interval.
...
**Answer**: For each added carat, the price is likely to increase by $7,756
...
**Answer**: For each unit of depth, the price will go down $29.65
...
**Answer**: That we are statistically confident that an increase in depth will always decrease the price of the diamond.
...
**Answer**: Yes. Depth is negative and carat is positive
...
**Answer**: Each individual slope represents that change in one unit of that slope while holding the other slope constant or unchanged.
